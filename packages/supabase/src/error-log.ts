...
export function counselorLoginNotRegisteredMessage(): string {
  return (
    "No Wayfinder Pro counselor account matches this email yet. Use the same @gvs.ga.gov address you enter on Joshua Tree referrals " +
    "(not a personal email). If referrals were submitted under a different address, ask your Employment Specialist to update your " +
    "referral email under Offices → Counselors and confirm your office (for example Valdosta) is active."
  );
}
