...
export function WayfinderTopNav({ badgeLabel, homeHref, productName }: Props) {
  return (
    <header className="sticky top-0 z-50 w-full border-b border-brand-green/30 bg-brand-white">
      ...
      >
        <Link
          href={homeHref}
          className="flex shrink-0 items-center gap-3 py-1 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-green"
        >
          <Image
