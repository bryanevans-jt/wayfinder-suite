...
insert into public.service_activity_types
  (code, category, name, default_minutes, min_minutes, max_minutes, requires_client, wayfinder_source_hint, sort_order)
values
  ('JT-INT-001', 'Intake & planning', 'Initial intake meeting', 30, 20, 60, true, 'contact_log · meeting', 10),
  ('JT-INT-002', 'Intake & planning', 'Individualized service plan development', 45, 30, 90, true, 'contact_log · stage_event', 20),
  ('JT-INT-003', 'Intake & planning', 'Referral and eligibility review', 20, 15, 45, true, 'contact_log', 30),
  ('JT-CON-010', 'Client contact', 'Client phone contact', 15, 5, 45, true, 'contact_log', 110),
  ('JT-CON-011', 'Client contact', 'Client in-person contact', 30, 15, 90, true, 'contact_log', 120),
  ('JT-CON-012', 'Client contact', 'Client video / telehealth contact', 30, 15, 60, true, 'contact_log', 130),
  ('JT-CON-013', 'Client contact', 'Client secure messaging', 15, 5, 30, true, 'client_messages', 140),
  ('JT-CON-014', 'Client contact', 'Scheduled client meeting', 30, 15, 120, true, 'client_meeting_requests', 150),
  ('JT-CON-015', 'Client contact', 'Home or community-based visit', 45, 30, 120, true, 'contact_log', 160),
  ('JT-EMP-020', 'Employment prep', 'Job search planning session', 45, 30, 90, true, 'contact_log', 210),
  ('JT-EMP-021', 'Employment prep', 'Résumé and cover letter development', 60, 30, 120, true, 'contact_log', 220),
  ('JT-EMP-022', 'Employment prep', 'Application completion assistance', 45, 20, 90, true, 'applications', 230),
  ('JT-EMP-023', 'Employment prep', 'Interview preparation', 45, 30, 90, true, 'contact_log', 240),
  ('JT-EMP-024', 'Employment prep', 'Mock interview / practice session', 45, 30, 60, true, 'contact_log', 250),
  ('JT-EMP-025', 'Employment prep', 'Job search coaching', 45, 30, 90, true, 'contact_log', 260),
  ('JT-EMP-026', 'Employment prep', 'Job canvassing / labor market survey', 60, 30, 180, true, 'contact_log', 270),
  ('JT-EMP-027', 'Employment prep', 'Employability / skills assessment', 45, 30, 90, true, 'contact_log', 280),
  ('JT-JOB-030', 'Job development', 'Employer job development call', 20, 10, 45, true, 'contact_log · employer_network', 310),
  ('JT-JOB-031', 'Job development', 'Employer site visit or meeting', 45, 30, 120, true, 'contact_log · employer', 320),
  ('JT-JOB-032', 'Job development', 'Employer relationship maintenance', 20, 10, 45, true, 'contact_log · employer', 330),
  ('JT-JOB-033', 'Job development', 'Job lead review with client', 20, 10, 45, true, 'contact_log', 340),
  ('JT-JOB-034', 'Job development', 'Interview scheduling coordination', 15, 10, 30, true, 'contact_log', 350),
  ('JT-PLC-040', 'Placement & retention', 'Job placement documentation', 30, 15, 60, true, 'applications · contact_log', 410),
  ('JT-PLC-041', 'Placement & retention', 'On-the-job check-in (client)', 30, 15, 60, true, 'contact_log', 420),
  ('JT-PLC-042', 'Placement & retention', 'Employer follow-up — job performance', 20, 10, 45, true, 'contact_log · employer', 430),
  ('JT-PLC-043', 'Placement & retention', 'Retention follow-up (30/60/90 day)', 30, 15, 45, true, 'contact_log', 440),
  ('JT-PLC-044', 'Placement & retention', 'Workplace accommodation support', 45, 30, 90, true, 'contact_log', 450),
  ('JT-PLC-045', 'Placement & retention', 'Job separation / offboarding support', 45, 30, 90, true, 'contact_log', 460),
  ('JT-CSE-050', 'Case coordination', 'Milestone / stage update', 15, 5, 30, true, 'client_stage_events', 510),
  ('JT-CSE-051', 'Case coordination', 'Case file review / documentation', 30, 15, 60, true, 'contact_log', 520),
  ('JT-CSE-052', 'Case coordination', 'Benefits and work-incentive counseling', 45, 30, 90, true, 'contact_log', 530),
  ('JT-CSE-053', 'Case coordination', 'Inter-agency coordination', 30, 15, 60, true, 'contact_log', 540),
  ('JT-CSE-054', 'Case coordination', 'Natural support coordination', 30, 15, 60, true, 'natural_support_contacts', 550),
  ('JT-CSE-055', 'Case coordination', 'Crisis / urgent client intervention', 60, 30, 120, true, 'contact_log', 560),
  ('JT-TRV-060', 'Travel', 'Client-related travel time', 30, 15, 120, true, 'manual', 610),
  ('JT-ADM-070', 'Non-client (internal)', 'Team meeting / staff supervision', 60, 15, 120, false, 'manual', 710),
  ('JT-ADM-071', 'Non-client (internal)', 'Training / professional development', 60, 30, 240, false, 'manual', 720),
  ('JT-ADM-072', 'Non-client (internal)', 'Administrative / overhead', 30, 15, 120, false, 'manual', 730)
