...
3. Open the email on the **same device** where you want to use the app (or copy the link carefully).
4. Tap the link → you land on your dashboard.
...
3. Follow your device prompt (Face ID, fingerprint, or device PIN).

**Tip:** Passkeys work best when you added the app to your **home screen** (see below).

If passkey fails, use a magic link again and contact Bryan Evans.
...
This gives a full-screen app experience without browser tabs.
...
The information in these applications is confidential and may not be shared outside Joshua Tree Service Group without written consent.
