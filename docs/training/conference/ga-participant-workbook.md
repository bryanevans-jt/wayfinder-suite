...
3. Log a contact (use a suggested chip if available)
4. Confirm **Notes** field is counselor-visible

**Client used:** ______________________

**What did you log?** ______________________
...
3. If facilitator approves, move one demo app to **Hired** and set **job start date**
...
**Did they receive it on Wayfinder client app?** Y / N
...
3. With a partner, practice **employer outreach** opening line (pair share)

**Employer you searched:** ______________________
...
3. Start **SE Monthly** for a GA client (don’t submit unless facilitator says)
4. Review **prefill** from contact logs

**What prefilled automatically?**
...
| Person | App | When | One-pager shared? |
|--------|-----|------|-------------------|
| Client | Wayfinder | | |
| Counselor | Wayfinder Pro | | |
| Employer | Community Partners join | | |
...
| App | URL |
|-----|-----|
| Wayfinder Pro | wayfinder-pro.thejoshuatree.org |
| Wayfinder (client) | wayfinder.thejoshuatree.org |
| Joshua Tree Reports | wayfinder-reports.thejoshuatree.org |

**Support:** bryan.evans@thejoshuatree.org · WF- error codes
