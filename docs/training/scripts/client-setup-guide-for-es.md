...
Use in person or by phone — 10–15 minutes.
...
Walk through opening the link. Troubleshoot spam folder.
...
| Show | Say |
|------|-----|
| Success path | “These are your milestones — we’ll update them as you progress.” |
...
> “Try sending me a test message now. If anything breaks, tell me — or email Bryan with the error code if you see one starting with **WF-**.”
...
- [ ] Test message received in Pro → Messages  
