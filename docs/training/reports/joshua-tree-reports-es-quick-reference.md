...
3. Log any contact gaps in Pro **before** prefill if job development section is empty
...
| Form | When |
|------|------|
| VPR | Progress documentation |
| JTSG VMR | Signed vocational monthly |
| EVF | Employment verification |
| JTSG TSVS | Vocational time sheet |
...
- [ ] Contact logs up to date in **Wayfinder Pro**  
