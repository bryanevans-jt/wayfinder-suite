...
export default async function CounselorQuickStartPage() {
  await requireCounselorSession();
    ...
    <main className="mx-auto max-w-lg px-6 py-10">
      ...
      <section className="mt-8 space-y-4 text-sm text-brand-black/85">
        ...
        <ol className="list-decimal space-y-2 pl-5">
          ...
          <li>Use your <strong>@thejoshuatree.org</strong> email</li>
          <li>
            <strong>Email me a magic link</strong> or <strong>Sign in with passkey</strong>
          </li>
        </ol>
