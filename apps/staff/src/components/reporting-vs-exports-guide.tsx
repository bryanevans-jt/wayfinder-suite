  ...
  return (
    <section className="rounded-xl border border-neutral-200 bg-neutral-50 p-5">
      ...
      <p className="mt-2 text-sm text-brand-black/75">
        These are different tools. Pick the one that matches what you need — they do not replace
        each other.
      </p>
      <dl className="mt-4 space-y-4 text-sm">
        ...
        >
          ...
          <dd className="mt-1 text-brand-black/80">
            ...
            (SE Monthly, VPR, JTSG VMR, EVF, time sheets). Creates PDFs, saves them to Google
            Drive, and emails you a confirmation. Opens in a separate app.
          </dd>
